/*main.js for Dog page (23.02.18) [v.0.0.16]*/
...
if($('#slider-container').attr('page') == 'main') {
	...
	var globalPathToImgFolder = `https://www.dog.dbrqx.com/index2/${dynamicImgPath}`;
}
...
function createSlider(){
	...
	if($('#slider-container').attr('page') == 'main') {
		...
		for (let i = 0; i<slider.numberOfNavImages; i++){
			...
			$('.big-img').attr('src', 'http://dog.dbrqx.com/index2/edu/0935x0700/edu_first_selection_2017_brqx_dog_025_0935x0700.jpg')
